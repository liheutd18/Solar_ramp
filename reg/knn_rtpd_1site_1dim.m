...
dt_rtd = 5; % min  L95 154
dt_rtpd = 15; % min

%T_reg_4sec = readtable('C:\Users\lxh180005\Desktop\solar ramp\ACE_REG_0919_Calculated_Transformed Josephine_2020_09_23.xlsx');
%RegPro = readtable('C:\Users\lxh180005\Desktop\solar ramp\ACE_REG_0919_Calculated_Transformed Josephine_2020_09_23.xlsx','Sheet','Regulation Reqs Transformed');
...
%% Load CAISO data RTD  %May =11488-14464//34561-43488/69972-78612
T_rtd = readtable('C:\Users\lxh180005\Desktop\solar ramp\SF2_code\tmp_excels\df_rtd.csv', 'Delimiter',',');
...
T_rtpd = readtable('C:\Users\lxh180005\Desktop\solar ramp\SF2_code\tmp_excels\df_rtpd.csv', 'Delimiter',',');
...
% Calculate net load forecast error 1.T_rtd.LOAD_B_RTD 2. T_rtpd.LOAD_B_RTPD
...
% tmp_rtpd_nl_a =  - sum(T_rtpd{:, {'Wind_NP15_RTPD', 'Wind_SP15_RTPD', 'Solar_NP15_RTPD', 'Solar_SP15_RTPD', 'Solar_ZP26_RTPD'}}, 2); % Note we use binding forecast as advisory forecast since CAISO does not publish advisory forecast
   ...
   solar_15min=-tmp_rtpd_nl_a(11517:14492);solar5min=-tmp_rtd_nl_b(34561:43488);
...
T_rtpd_error_max_may=T_rtpd.error_max(11517:14492,:);%14464-14492
T_rtpd_error_min_may=T_rtpd.error_min(11517:14492,:);
Time_reg=T_rtpd.TIME(11489:14464,:);%-28 11517:14492
% Demonstrate FRP requirements and binding interval forecasts, RTPD
plot(Time_reg, REUPmin, '-b', Time_reg, REUDmin, '-b', Time_reg, T_rtpd_error_max_may, '-r', Time_reg, T_rtpd_error_min_may, '-r');
hold on
plot(Time_reg,ACE_STARmin,'-g',Time_reg,ACEmin,'-g');
% plot(T_rtpd_error_max_may);
% hold on
% plot(T_rtpd_error_min_may);
% hold on
% plot(ACE_STARmin);
% figure();
%ax1 = subplot(2, 1, 1);
...
dirwork = 'C:\Users\lxh180005\Desktop\solar ramp\SF2_code\IBM\F_pwr.201908.15min';
for i = 1: numel(uniquegen)
    gen = uniquegen{i};
    for m = 1: numel(month_ibm)
        mstr = num2str(month_ibm(m));
        dirwork = strcat('C:\Users\lxh180005\Desktop\solar ramp\SF2_code\IBM\F_pwr.', mstr, '.15min');
    ...
    addpath('C:\Users\lxh180005\Desktop\solar ramp\SF2_code\MATLAB_PV_LIB-master');
